...
% y_seg1 = 
% for pos = 1:101
%     if x_direct(pos) < a_max_defl
%     y_seg1 = 
%     elseif x_direct(pos) >= a_max_defl && x_direct(pos) < a_max_defl + dist1
% 
%     elseif x_direct(pos) >= a_max_defl + dist1 && x_direct(pos) < a_max_defl + dist1 + dist2
% 
%     elseif x_direct(pos) >= a_max_defl + dist1 + dist2 && x_direct(pos) < a_max_defl + 2*dist1 + dist2
% 
%     else
% 
%     end
...
%%
a1 = a_max_defl; a2 = a1 + dist1; a3 = a2 + dist2; a4 = a3 + dist1;
x_direct = linspace(0, 0.9, 101);
a_pos = zeros(1, 4);
...
plot(x_direct(59), y(59), 'r*')
xlabel('Bridge Deflection when the car is at the location that make the bridge deflect most')
ylabel('Deflection')
hold off